...
function themememe_setup() {
	...
	register_nav_menus( array(
		'top' => __( 'Top Menu', 'themememe' ),
		'main' => __( 'Main Menu', 'themememe' ),
	) );
}
endif;
...
function themememe_continue_reading_link() {
	return ' <p class="more-link"><a href="'. esc_url( get_permalink() ) . '">' . __( 'Lire la suite <span class="meta-nav">&rarr;</span>', 'themememe' ) . '</a></p>';
}
